  ...
  <body>
    ...
    <div class="top-wrapper text-center text-white">
      <div class="top-character">
        ...
        <a href="register.php" class="btn btn-lg btn-secondary mt-3 mb-3 mx-2"><span><i class="far fa-address-book"></i></span>  会員登録</a>
        <a href="login.php" class="btn btn-lg btn-warning mt-3 mb-3 mx-2"><span><i class="fas fa-sign-in-alt"></i></span>  ログイン</a>
      </div>
    </div>
    ...
    <div class="post-wrapper pt-5">
      <div class="container">
        ...
        <!-- ここまで繰り返し -->
        <!-- ページネーション -->
        <div class="paginate m-auto pb-5">
          <ul class="page_link">
            <?php if ($prev >= 1): ?>
    ...
    <div class="under-wrapper text-center">
      <div class="under-character  py-5">
        <h2>思い出の漫画を投稿してみませんか？</h2>
        <br>
        <h3>Let's Posting Your memorable comic!</h3>
        <a href="register.php" class="btn btn-lg btn-secondary my-3 mx-2"><span><i class="far fa-address-book"></i></span>  会員登録</a>
        <a href="login.php" class="btn btn-lg btn-warning my-3 mx-2"><span><i class="fas fa-sign-in-alt"></i></span>  ログイン</a>
      </div>
    </div>
    <!-- End under-wrapper -->

    <!-- fotter -->
    <footer class="text-light bg-primary pt-4 pb-4 mt-5">
